...
export default class ValidationForm {
    ...
    checkType() {
        ...
        if (formControlValue.startsWith('2')) {
        ...
        } else if (formControlValue.startsWith('51') || formControlValue.startsWith('52') || formControlValue.startsWith('53') || formControlValue.startsWith('54') || formControlValue.startsWith('55')) {
            const cardTypeMastercard = document.querySelector('.cards-list__item_mastercard');
            cardList.showCardImg(cardTypeMastercard);
        } else if (formControlValue.startsWith('34') || formControlValue.startsWith('37')) {
            ...
            const cardTypeDiscover = document.querySelector('.cards-list__item_discover');
            cardList.showCardImg(cardTypeDiscover);
        } else if (formControlValue.startsWith('31') || formControlValue.startsWith('35')) {
            const cardTypeJCB = document.querySelector('.cards-list__item_jcb');
            cardList.showCardImg(cardTypeJCB);
        } else if (formControlValue.startsWith('30') || formControlValue.startsWith('36') || formControlValue.startsWith('38')) {
